...
class ScopedFirebaseCoreService(
  ...
  companion object {
    ...
    private fun getEncodedExperienceScopeKey(experienceKey: ExperienceKey): String {
      return try {
        ...
        Integer.toString(experienceKey.scopeKey.hashCode())
      }
    }
    ...
    private fun getOptionsFromManifest(manifest: RawManifest): FirebaseOptions? {
      return try {
        ...
        json.addJSONStringToMap(googleServicesFile, "project_info.project_id", "projectId")
        json.addJSONStringToMap(googleServicesFile, "project_info.project_number", "messagingSenderId")
        json.addJSONStringToMap(googleServicesFile, "project_info.firebase_url", "databaseURL")
        json.addJSONStringToMap(googleServicesFile, "project_info.storage_bucket", "storageBucket")
  ...
  init {
    ...
    synchronized(protectedAppNames) {
      val forRemoval: MutableSet<String> = HashSet()
